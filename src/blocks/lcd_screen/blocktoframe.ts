...
export const lcdScroll: BlockToFrameTransformer = (
  ...
  return [
    arduinoFrameByComponent(
      ...
      timeline,
      newComponent,
      `Мәтінді жылжыту ${direction.toLowerCase()}.`,
      previousState
    ),
  ];
};
...
export const lcdPrint: BlockToFrameTransformer = (
  ...
  return [
    arduinoFrameByComponent(
      ...
      timeline,
      newComponent,
      `Экранға "${print}" орнын басып шығару (${column}, ${row}).`,
      previousState
    ),
  ];
};
...
export const lcdSimplePrint: BlockToFrameTransformer = (
  ...
  return [
    arduinoFrameByComponent(
      ...
      timeline,
      newComponent,
      `Хабар ${delay.toFixed(2)} секундқа басып шығарылуда.`,
      previousState,
      false,
      false,
      delay * 1000
