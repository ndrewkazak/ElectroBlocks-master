...
export const registerFunctionMenu = (workspace: WorkspaceSvg) => {
  workspace.registerToolboxCategoryCallback("ELECTROBLOCKS_FUNCTIONS", () => {
    const xmlList: Element[] = [];
    if (Blockly.Blocks["procedures_defnoreturn"]) {
      // <block type="procedures_defnoreturn" gap="16">
      //     <field name="NAME">Іс әрекет орында</field>
      // </block>
    ...
    function populateProcedures(procedureList, templateName) {
      for (let i = 0; i < procedureList.length; i++) {
        ...
        //   <mutation name="Іс әрекет орында">
