...
export const registerVariableMenu = (workspace: WorkspaceSvg) => {
  workspace.registerToolboxCategoryCallback("ELECTROBLOCKS_VARIABLES", (_) => {
    ...
    btnNumVariable.setAttribute("text", "Сандық айнымалысын құру");
    ...
    btnStringVariable.setAttribute("text", "Мәтін айнымалысын құру");
    ...
    btnBoolVariable.setAttribute("text", "Логикалық айнымалыны құру");
    ...
    btnColourVariable.setAttribute("text", "Түс айнымалысын құру");
