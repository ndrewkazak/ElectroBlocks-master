...
export const registerListMenu = (workspace: WorkspaceSvg) => {
  ...
  workspace.registerToolboxCategoryCallback("LIST", () => {
    ...
    btnCreateNumberList.setAttribute("text", "Сандар тізімін жасау");
    ...
    btnCreateStringList.setAttribute("text", "Жолдар тізімін жасау");
    ...
    btnCreateBooleanList.setAttribute("text", "Логикалық тізімді жасау");
    ...
    btnCreateColorList.setAttribute("text", "Түстер тізімін жасау");
